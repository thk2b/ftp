...
CLIENT_SRC = $(SHARED_SRC) $(addprefix src/client/, commands.c status.c parse_addr.c init.c get_request.c send_request.c get_response.c run.c main.c\
	$(addprefix handlers/, quit_handler.c list_handler.c pwd_handler.c cwd_handler.c retr_handler.c stor_handler.c pasv_handler.c mkd_handler.c dele_handler.c rmd_handler.c)\
)
